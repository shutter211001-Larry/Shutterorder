...
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;ALTER TABLE "locations" ADD COLUMN IF NOT EXISTS "hourlyNationalHolidayMultiplier" DOUBLE PRECISION NOT NULL DEFAULT 2.0;
...
DO $$ BEGIN
    ...
    END IF;
END $$;ALTER TABLE "leave_requests" DROP CONSTRAINT IF EXISTS "leave_requests_managerId_fkey";
DO $$ BEGIN
