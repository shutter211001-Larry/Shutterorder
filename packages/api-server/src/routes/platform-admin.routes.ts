...
import { listTenants, createTenant, updateTenant, deleteTenant, cancelTenantDeletion, resetDemoTenant, getTenantIntegrations, updateTenantIntegrations, sendWelcomeEmail, getTenantLocations } from '../controllers/platform-admin.controller.js';
...
router.post('/tenants/:id/cancel-deletion', cancelTenantDeletion);
